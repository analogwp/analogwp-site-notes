...
const AdminSidebar = () => {
    return (
        <div className="cht-admin-sidebar">
            <div className="cht-sidebar-header">
                <div className="cht-wp-logo">
                ...
                <span className="cht-admin-title">DashPro</span>
            </div>
            
            <nav className="cht-sidebar-nav">
                <ul>
                    <li className="cht-nav-item active">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Dashboard', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            {__('Home', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Updates', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-separator">
                        <hr />
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Posts', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Media', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Pages', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Comments', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-separator">
                        <hr />
                    ...
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Elementor', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Templates', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Style Kits', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-separator">
                        <hr />
                    ...
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Appearance', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Plugins', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Users', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Tools', 'client-handoff-toolkit')}
                        </a>
                    </li>
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                    ...
                    <li className="cht-nav-item">
                        <a href="#" className="cht-nav-link">
                            ...
                            {__('Collapse menu', 'client-handoff-toolkit')}
                        </a>
                    </li>
                </ul>
            </nav>
