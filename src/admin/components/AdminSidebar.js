...
/**
 * Legacy sidebar component — uses semantic design system classes.
 * Not currently wired into the admin app.
 */
const AdminSidebar = () => {
	return (
		<div className="sn-sidebar">
			<div className="sn-sidebar__header">
				<div className="sn-sidebar__logo">
				...
				<span className="sn-sidebar__title">DashPro</span>
			</div>

			<nav className="sn-sidebar__nav">
				<ul className="sn-sidebar__nav-list">
					<li>
						<a href="#" className="sn-sidebar__nav-item sn-sidebar__nav-item--active">
							{__('Dashboard', 'analogwp-site-notes')}
						</a>
					</li>
					<li>
						<a href="#" className="sn-sidebar__nav-item">
